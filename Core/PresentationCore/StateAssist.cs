...
{
    /// <summary>
    ///     Takes care of the visual state managing. This is ment to replace WPFs triggers, which has become somewhat obsolete.
    /// </summary>
    public class StateAssist
    {
        #region State assist 1
        public static readonly DependencyProperty State1Property =
            DependencyProperty.RegisterAttached("State1", typeof(string), typeof(StateAssist),
